...
const CATEGORIES = [
  ...
  "Job Posting","Resume & CV","Interview","Career Advice","Internship",
  "Freelance","Remote Work","Salary & Compensation","Company Review","Networking"
];
...
const PRESET_TAGS = [
  ...
  // Jobs & Career
  "Job Alert", "Hiring Now", "Remote Job", "Hybrid", "On-Site",
